...
import sty from "./PlasmicHomeCta.module.css"; // plasmic-import: --cvKnhxFXDSY/css
import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: EOwPinbs_wEi-7/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__oudgw)}
      >
        <div
          className={classNames(
            projectcss.all,
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__jb17K)}
        >
          <TextInput
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
        <div className={classNames(projectcss.all, sty.freeBox__km1Rh)}>
          <SphereIcon
