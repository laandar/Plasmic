...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: a0eLfdii839v8h/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: BSqgncjP6AOvv6/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__sXK1)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__blCyu)}
                role={"img"}
              />
            ),
